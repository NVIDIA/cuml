...
4. Get familiar with the developer guide relevant for you:
    * For C++ developers it is available here [C++ Developer Guide](docs/source/developer_guide/cpp/developer_guide.md)
    * For Python developers, a [Python Developer Guide](docs/source/developer_guide/python/developer_guide.md) is available as well.
