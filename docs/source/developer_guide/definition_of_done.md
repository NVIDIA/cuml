...
- User-facing API is [stateless](cpp/developer_guide/#public-cuml-interface) and follows the [plain-old data (POD)](https://en.wikipedia.org/wiki/Passive_data_structure) design paradigm
...
- Estimators follow the implementation guidelines in [Estimator Guide](python/estimator_guide/)
